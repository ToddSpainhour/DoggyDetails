...
namespace DoggyDetails.Controllers
{
    ...
    public class OwnersController : ControllerBase
    {
        ...
        {
            using SqlConnection con = new SqlConnection(_configuration.GetConnectionString("DoggyDetailsConnectionString").ToString());
            try
            {
            ...
            {
                Console.WriteLine($"Oh, no! Something went wrong in the GetAlOwners method. Error Info: {ex}");
                throw;
            }
        ...
        { 
            ...
            {
                Console.WriteLine($"Oh, no! Something went wrong in the CheckUsernameAvailability method. Error Info: {ex}");
                throw;
            }
        }
        ...
        public object CreateNewOwner([FromBody]Owner newOwner)
        {
            ...
            {
                Console.WriteLine($"Oh, no! Something went wrong in the CreateNewOwner method. Error Info: {ex}");
                throw;
            } 
        }
        ...
        public int OwnerLogin([FromBody] Owner loginInfo)
        {
            ...
            {
                Console.WriteLine($"Oh, no! Something went wrong in the OwnerLogin method. Error Info: {ex}");
                throw;
            }
        }
    }
